...
public class Post {
    ...
    public boolean equals(Object o) {
        ...
        Post post = (Post) o;
        return Objects.equals(id, post.id) && Objects.equals(title, post.title) && Objects.equals(content, post.content) && Objects.equals(author, post.author) && Objects.equals(category, post.category) && Objects.equals(tags, post.tags) && status == post.status && Objects.equals(createdAt, post.createdAt) && Objects.equals(updatedAt, post.updatedAt) && Objects.equals(readingTime, post.readingTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, title, content, author, category, tags, status, createdAt, updatedAt, readingTime);
    }
